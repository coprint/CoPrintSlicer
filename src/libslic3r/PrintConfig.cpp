...
void PrintConfigDef::init_fff_params()
{
    ...
    */
    ...
    def->min = 0;
    def->mode = comAdvanced;
    def->aliases.push_back("infill_extruder");
    def->aliases.push_back("sparse_infill_filament");
    def->set_default_value(new ConfigOptionInt(0));
    ...
    def->min = 0;
    def->mode = comAdvanced;
    def->aliases.push_back("perimeter_extruder");
    def->aliases.push_back("wall_filament");
    def->aliases.push_back("wall_filament_id");
    def->aliases.push_back("outer_wall_filament");
    def->set_default_value(new ConfigOptionInt(0));
    ...
    def->min = 0;
    def->mode = comAdvanced;
    def->aliases.push_back("inner_wall_filament");
    def->set_default_value(new ConfigOptionInt(0));
