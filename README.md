...
3. *If you want to run a build from a PR, or the app is not yet notarized by Apple, you may need to follow the steps below:*
    ...
    - Option 3 (via System Settings):
      - Step 1: Open the app — a warning window will pop up:
        <br><img alt="mac_cant_open" src="./resources/docs/mac_step1_cant_open.jpeg" width="320">
      - Step 2: Go to `System Settings` → `Privacy & Security`, and click **Open Anyway**:
        <br><img alt="mac_security_setting" src="./resources/docs/mac_step2_open_anyway.jpeg" width="320">
      - Step 3: Confirm with Touch ID or your password when prompted:
        <br><img alt="mac_touch_id_confirm" src="./resources/docs/mac_step3_confirm.jpeg" width="320">
      - Step 4: In the dialog that appears again, click **Open**:
        <br><img alt="mac_open_again" src="./resources/docs/mac_step4_open.jpeg" width="320">
    </details>
